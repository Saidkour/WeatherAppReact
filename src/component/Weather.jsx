    ...
    <>
      <div className='p-5 backdrop-blur-sm rounded mt-5 border text-center'>
        {(isLoading) ? <div className='flex justify-center'>
          ...
          </svg></div> : (datat.temp !== undefined) ? <div className='lg:flex block lg:justify-around'>
            <div className='lg:max-w-[50%] max-w-[100%]'>
              <div className='flex  justify-center'>
                <div className='block'>
                  <h6> {datat.city}, {datat.country}</h6>
                ...
                <span>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-geo-alt-fill mt-[3px] ml-2" viewBox="0 0 16 16">
                    <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6" />
                  </svg>
                </span>
              </div>
              <div className='flex justify-center p- lg:p-10 min-w-[100%]'>
                <img src={`http://openweathermap.org/img/wn/${datat.icon}@2x.png`} alt="test" width='100px' height='auto' />
              ...
              <div className='flex justify-center'>
                <hr className='w-[100px] md:hidden my-5 md:my-0' />
              </div>
            </div>
            <div className='lg:max-w-[50%] max-w-[100%]'>
              <div className='block sm:flex justify-center max-w-[100%]'>
                <div className='flex mb-2 sm:mb-0 justify-center'>
                  <div className='border flex flex-col justify-center rounded p-3 ml-4 w-[100px] h-[100px]  '>
                    <h6 className='flex justify-center'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-sunrise" viewBox="0 0 16 16">
                    ...
                    <p className='font-medium text-semi-gray '>{formatdate(datat.sunrise)}</p>
                  </div>
                  <div className='border flex flex-col justify-center rounded p-3 ml-4 w-[100px] h-[100px]  '>
                    ...
                    <p className='font-medium text-semi-gray '>{formatdate(datat.sunset)}</p>
                  </div>
                </div>
                <div className='flex mb-2 sm:mb-0 justify-center'>
                  <div className='border flex flex-col justify-center rounded p-3 ml-4 w-[100px] h-[100px]  '>
                    <h6 className='flex justify-center'>pressure</h6>
                    <p className='font-medium text-semi-gray '>{datat.pressure} hPa</p>
                  </div>
                  <div className='border flex flex-col justify-center rounded p-3 ml-4 w-[100px] h-[100px]  '>
                    ...
                    <p className='font-medium text-semi-gray '>{datat.cloud} %</p>
                  </div>
                </div>
                <div className='flex mb-2 sm:mb-0 justify-center'>
                  <div className='border flex flex-col justify-center rounded p-3 ml-4 w-[100px] h-[100px]  '>
                    <h6 className='flex justify-center'>humidity</h6>
                    <p className='font-medium text-semi-gray '>{datat.humidity} %</p>
                  </div>
                </div>
              </div>
            </div>
